...
class GoGenerator:
    ...
    def generate(self, dir: str):
        ...
        for prefix in prefixes:
            ...
            with open(
                os.path.join(dir, f"types_{prefix}.go"), "w", encoding="utf-8"
            ) as f:
            ...
            if not (_type.attributes or _type.elements):
                ...
                for child in _type.elements:
                    ...
                    if child.type:
                        ...
                        f.write(
                            self._to_xml_tag(child.name, omittable, plural=plural)
                            + "\n"
                        )
                    elif child.ref:
                        ...
                        f.write(
                            self._to_xml_tag(ref.name, omittable, plural=plural) + "\n"
                        )
                    else:
